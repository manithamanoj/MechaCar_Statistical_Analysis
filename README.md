...
# Introduction
In this challenge we and the data analytics team will review the production data of MechaCar, which has production issues and are blocking the manufacturing team’s progress. We will be finding insights that may help the manufacturing team. For that we are going to,
